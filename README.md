...
8. You also may need to run `npm i config` and `npm i i18n` if the app still fails to run. After these changes, re-try `npm install`, and then `npm start` after successful install.
